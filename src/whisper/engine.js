...
const { resolveBuild, resolveModel } = require('./catalog');
// The download/unpack plumbing is shared with the local chat engine. See
// src/artifacts.js -- it was lifted out of this file unchanged.
const {
  mkdirp, exists, tarBin, extract, walk, findBinary,
  portFree, pickPort, download, assetExists, sha256
} = require('../artifacts');
